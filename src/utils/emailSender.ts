...
import { getAutenticateAccount } from './emailHTML';
...
const transporter = nodemailer.createTransport({
  ...
  export const sendEmail2 = async (to: string, subject: string, text: string, user:string, products1, products2) => {
      try {
          const mailOptions = {
              from: '"Amazon Scrapler" <programadorigorrb@gmail.com>', // Remetente
              to, // Destinatário
              subject, // Assunto
              html: getAutenticateAccount(user, text, products1,products2),
